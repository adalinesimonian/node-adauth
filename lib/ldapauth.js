 ...
 *    groupSidProperty {String}
 *        Optional, default 'objectSid'. The binary property of user to use
 *        in '{{sid}}' interpolation of groupSearchFilter.
 ...
 *        configured with groupDnProperty, '{{sid}}' the Object SID property
 *        configured with groupSidProperty (requires includeRaw, the binary
 *        result is converted to Object SID string)
...
function LdapAuth(opts) {
  ...
  this.opts.groupSidProperty || (this.opts.groupSidProperty = 'objectSid');
